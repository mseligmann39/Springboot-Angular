...
public class TransferenciaController {
	...
	@PostMapping
	public TransferenciaModel guardarTransferencia(@Valid @RequestBody TransferenciaModel Transferencia) {
	...
	@PutMapping("/{id}")
	public TransferenciaModel actualizarTransferencia(@PathVariable("id") Long id, @RequestBody TransferenciaModel transferencia) {
		return this.transferenciaService.actualizarTransferencia(id, transferencia);
